...
module.exports.aws_key = process.env.AWS_KEY || "AKIAJ7FAQZI6NLZVPNHQ"; // AWS Key
module.exports.aws_secret = process.env.AWS_SECRET || "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"; // AWS Secret
